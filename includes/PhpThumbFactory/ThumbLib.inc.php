<?php
/**
 * PhpThumbGxd Library Definition File
 * 
 ...
 * PhpThumbGxd : PHP Thumb Library <http://phpthumb.gxdlabs.com>
...
class PhpThumbFactory
{
	 ...
	 *  - Getting an instance of PhpThumbGxd
	 *  - Loading plugins
	...
	public static function create ($filename = null, $options = array(), $isDataStream = false)
	{
		...
		// grab an instance of PhpThumbGxd
		$pt = PhpThumbGxd::getInstance();
		// load the plugins
